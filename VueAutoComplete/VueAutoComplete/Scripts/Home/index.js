    ...
    methods: {
        ...
        setResult(result) {
            ...
            if (vm.results.length !== 0) {
                vm.searchValue = result;
                vm.clearAll();
            }
        },
        onArrowDown() {
            console.log('onArrowDown');
            if (this.currentlyCounter < this.results.length && this.results.length - 1 > this.currentlyCounter) {
                this.currentlyCounter = this.currentlyCounter + 1;
            }
        },
        onArrowUp() {
            console.log('onArrowUp');
            if (this.currentlyCounter > 0) {
                this.currentlyCounter = this.currentlyCounter - 1;
            }
        },
        onEnter() {
            ...
            var vm = this;
            if (vm.isOpen) {
                vm.searchValue = vm.results[vm.currentlyCounter];
            }
            vm.clearAll();
        },
        onEsc() {
